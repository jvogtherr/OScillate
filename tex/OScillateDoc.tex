...
%hinzugefügt
Um der Realität etwas näher zu kommen gibt es nicht nur Studenten die Bus fahren, sondern es wird mithilfe einer Polynomfunktion eine \glqq Hintergrundlast\grqq~die andere Fahrgäste darstellen soll. Die verwendete Funktion besitzt ein Maximum morgens und eines zum Feierabendverkehr.
...
%Anmerkungen:
%Die Positionierung der Grafiken ist so noch nicht final. Da kümmere ich mich drum, wenn der Text steht ;)
%Erstie ist immer auf 0
%Der Rest ist bei s1 bei defaultwerten
%bei s2 gibt es 10.000 Studenten
%Die ganze arbeit ist jetzt schon viel zu lang >_>'
